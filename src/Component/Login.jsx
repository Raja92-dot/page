      ...
      <div className="col-12 col-lg-10 col-xl-8">
        <div className="row gy-5 justify-content-center">
          <div className="col-12 col-lg-5">
            <form action="#!">
              <div className="row gy-3 overflow-hidden">
                ...
                <div className="col-12">
                  <div className="form-floating mb-3">
                    <input type="password" className="form-control border-0 border-bottom rounded-0" name="password" id="password" defaultValue placeholder="Password" required />
          ...
          <div className="col-12 col-lg-2 d-flex align-items-center justify-content-center gap-3 flex-lg-column">
            <div className="bg-dark h-100 d-none d-lg-block" style={{"width":"1px","--bs-bg-opacity":".1"}} />
            <div className="bg-dark w-100 d-lg-none" style={{"height":"1px","--bs-bg-opacity":".1"}} />
            <div>or</div>
            <div className="bg-dark h-100 d-none d-lg-block" style={{"width":"1px","--bs-bg-opacity":".1"}} />
            <div className="bg-dark w-100 d-lg-none" style={{"height":"1px","--bs-bg-opacity":".1"}} />
          </div>
